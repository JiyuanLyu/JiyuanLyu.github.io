...
def coef(data_group):
    """
    Calculate the simple estimate of the year-over-year average change in temperature in each month at each station.
...
def temperature_coefficient_plot(country, year_begin, year_end, month, min_obs, **kwargs):
    ...
    **kwargs: addtional keyword arguments passed to px.scatter_mapbox()
    ...
    # Create the dataframe with given information using the function constructed in Part 2
    ...
    s = ("Estimates of yearly increase in temperature in {} for stations in {}, years {} - {}")
    title = s.format(calendar.month_name[month], country, year_begin, year_end)
...
In this part, I construct the barplot visualization based on the function `temperature_coefficient_plot()` in Part 3.
...
def my_barplot(country, year_begin, year_end, month, **kwargs):
    ...
    **kwargs: addtional keyword arguments passed to px.scatter_mapbox()
    ...
    # Plot the barplot
    s = ("Average temperature in {} for stations in {}, years {} - {}")
    title = s.format(calendar.month_name[month], country, year_begin, year_end)
...
This heatmap shows the change in average temperature for a specific month in a specific country by the longitude during a specific year range. 
...
def my_heatmap(country, year_begin, year_end, month, **kwargs):
    ...
    **kwargs: addtional keyword arguments passed to px.scatter_mapbox()
    ...
    # Plot the barplot
    s = ("Average temperature in {} for stations in {} by longitude, years {} - {}")
    title = s.format(calendar.month_name[month], country, year_begin, year_end)
